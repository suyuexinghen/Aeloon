...
from aeloon.core.config.schema import ChannelsConfig
...
def test_discover_plugins_loads_entry_points():
    from aeloon.channels.registry import discover_plugins
...
def test_builtin_channel_default_config():
    ...
    from aeloon.channels.telegram import TelegramChannel
