...
from aeloon.core.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from aeloon.core.agent.tools.registry import ToolRegistry
from aeloon.core.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("aeloon.core.agent.tools.mcp.logger.warning", _warning)
