...
from aeloon.services.cron.types import CronJobState, CronSchedule
...
class CronTool(Tool):
    ...
    def set_turn_context(self, ctx: TurnContext) -> None:
        """Backward-compatible turn-context setter."""
        self._channel = ctx.channel
        self._chat_id = ctx.chat_id

    def on_turn_start(self, ctx: TurnContext) -> None:
        """Refresh delivery target metadata for the new turn."""
