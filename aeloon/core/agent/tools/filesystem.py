    ...
    async def execute(self, path: str, content: str, **kwargs: Any) -> str:
        ...
        try:
            ...
            if policy is not None:
                veto = await policy.before_operation("write", str(fp))
                if veto is not None:
                    return f"Error: {veto}"
            ...
            # Policy: after write
            if policy is not None:
                result = await policy.after_operation("write", str(fp), result)
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            policy = get_file_policy()
            if policy is not None:
                veto = await policy.before_operation("edit", str(fp))
                if veto is not None:
                    return f"Error: {veto}"
            ...
            result = f"Successfully edited {fp}"

            # Policy: after edit
            if policy is not None:
                result = await policy.after_operation("edit", str(fp), result)
