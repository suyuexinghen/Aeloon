...
class Tool(ABC):
    ...
    def set_turn_context(self, ctx: "TurnContext") -> None:
        """Deprecated compatibility hook for older tools."""
        return None

    def on_turn_start(self, ctx: "TurnContext") -> None:
        """Primary turn-start hook invoked once at the start of each turn."""
        self.set_turn_context(ctx)

    def should_suppress_final_reply(self) -> bool:
        """Whether this tool requests suppressing the final assistant reply."""
        return False
